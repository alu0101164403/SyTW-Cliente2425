 ...
 */
export declare abstract class ActorRdfJoinEntriesSort<TS = undefined> extends Actor<IActionRdfJoinEntriesSort, IActorTest, IActorRdfJoinEntriesSortOutput, TS> {
    /**
     * @param args -
...
export type IActorRdfJoinEntriesSortArgs<TS = undefined> = IActorArgs<IActionRdfJoinEntriesSort, IActorTest, IActorRdfJoinEntriesSortOutput, TS>;
